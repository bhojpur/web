...
func TestRequired(t *testing.T) {
	...
	if !valid.Required("bhojpur", "string").Ok {
...
func TestMatch(t *testing.T) {
	...
	if valid.Match("sanjay@bhojpur", regexp.MustCompile(`^\w+@\w+\.\w+$`), "match").Ok {
		t.Error("\"sanjay@bhojpur\" match \"^\\w+@\\w+\\.\\w+$\"  should be false")
	}
	if !valid.Match("sanjay@bhojpur.net", regexp.MustCompile(`^\w+@\w+\.\w+$`), "match").Ok {
		t.Error("\"sanjay@bhojpur\" match \"^\\w+@\\w+\\.\\w+$\"  should be true")
	}
}
...
func TestNoMatch(t *testing.T) {
	...
	if valid.NoMatch("123@bhojpur", regexp.MustCompile(`[^\w\d]`), "nomatch").Ok {
		t.Error("\"123@bhojpur\" not match \"[^\\w\\d]\"  should be false")
	}
	if !valid.NoMatch("123bhojpur", regexp.MustCompile(`[^\w\d]`), "match").Ok {
		t.Error("\"123@bhojpur\" not match \"[^\\w\\d@]\"  should be true")
	}
}
...
func TestEmail(t *testing.T) {
	...
	if !valid.Email("sanjay@bhojpur.com", "email").Ok {
		t.Error("\"sanjay@bhojpur.com\" is a valid email address should be true")
	}
	if valid.Email("@anjay@bhojpur.net", "email").Ok {
		t.Error("\"@anjay@bhojpur.net\" is a valid email address should be false")
	}
	if valid.Email("sanjay@bhojpur.net ok", "email").Ok {
		t.Error("\"sanjay@bhojpur.net ok\" is a valid email address should be false")
	}
}
...
func TestIP(t *testing.T) {
	...
	if !valid.IP("01.11.11.11", "IP").Ok {
		t.Error("\"sanjay@bhojpur.net\" is a valid ip address should be true")
	}
}
...
func TestBase64(t *testing.T) {
	...
	if valid.Base64("sanjay@bhojpur.net", "base64").Ok {
		t.Error("\"sanjay@bhojpur.net\" are a valid base64 characters should be false")
	}
